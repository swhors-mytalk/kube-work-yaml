...
DEPLOY_FILE=template/bemily-api-deploy.yaml
SERVICE_FILE=template/bemily-api-service-node_port.yaml
AUTOSCALE_FILE=template/bemily-api-autoscaling.yaml
FILES=($DEPLOY_FILE $SERVICE_FILE $AUTOSCALE_FILE)
SVC_DEP_FILE="bemily-api-svc-dep.yaml"
